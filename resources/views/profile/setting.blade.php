            ...
            <div class="col-md-12">
                <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-2 gap-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('profile.password') }}"><i
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAccountDeactivation" action="{{ route('profile.destroy') }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-danger deactivate-account" id="btnDeleteAccount"
                                disabled>
                                Deactivate Account
                            </button>
                        </form>
        ...
        $(document).ready(function() {
            $('#accountActivation').on('change', function() {
                if($(this).is(':checked')) {
                    ...
                    $('#btnDeleteAccount').attr('disabled', 'disabled');
                }
            });
            ...
            $('#formAccountDeactivation').on('submit', function(e) {
                ...
                Swal.fire({
                    ...
                    text: "Apakah Anda benar-benar ingin menghapus akun? Tindakan ini permanen!",
                    icon: 'error',
