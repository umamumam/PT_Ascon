...
<style>
    ...
    .news-title {
        ...
        overflow: hidden;
        height: 3.4rem; /* Enforce uniform height for titles */
    }
    ...
    .news-excerpt {
        ...
        -webkit-box-orient: vertical;
        overflow: hidden;
        height: 4.2rem; /* Enforce uniform height for text */
...
<section id="landingNewsHeader" class="section-py bg-white">
    <div class="container">
        ...
        <div class="row mb-5 mt-10 justify-content-center text-center">
            <div class="col-lg-8">
                <h6 class="text-muted fw-bold mb-2 text-uppercase tracking-wider" style="letter-spacing: 2px; font-size: 0.8rem;">eServices / News Update</h6>
                <h1 class="display-4 fw-extrabold text-dark mb-3">Our Latest Insights</h1>
                <p class="text-muted mx-auto" style="max-width: 600px; font-size: 0.95rem;">Stay updated with the latest news, logistics solutions, and transport updates from PT Asia Connexindo Internasional.</p>
                <div class="mt-4">
        ...
        <div class="row g-4 mt-2 justify-content-start">
            ...
            @empty
                <div class="col-12">
                    <div class="text-center text-muted py-5 card border-0 shadow-sm" style="border-radius: 12px;">
