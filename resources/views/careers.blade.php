...
<section id="landingCareers" class="section-py bg-white" style="padding-top: 180px !important;">
    <div class="container">
        <div class="row mb-5 reveal-on-scroll">
            <div class="col-lg-12">
        ...
        <div class="row g-4 reveal-on-scroll delay-200">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card h-100 border-0 shadow-sm p-5"
                    style="background-color: #ffffff; border-radius: 4px; min-height: 400px;">
            ...
            <div class="col-lg-4 col-md-6 d-none d-md-block">
                <div class="h-100 border-0" style="background-color: #fcfcfc; min-height: 400px; border-radius: 4px;">
                </div>
            </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div>
                            ...
                            <small class="text-dark">{{ $job->location }} • {{ $job->type }}</small>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body text-dark" style="line-height: 1.8;">
                        @if($job->description)
