    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 mb-4 reveal-on-scroll">
                <h6 class="text-dark fw-bold mb-2">Our Services</h6>
            ...
            <div class="col-lg-6 mb-4 mb-lg-0 reveal-on-scroll">
                ...
                <div class="text-dark" style="line-height: 1.8; text-align: justify;">
                    <p>It's a group of LCL cargo from different shippers or consignors that are consolidated and sent to
                        ...
                        Groupage Operation.</p>
                </div>
            </div>
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/11062b_6ff3c979633d4d72b090b4d7238f9da6~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/11062b_6ff3c979633d4d72b090b4d7238f9da6~mv2.jpg"
                    alt="Sea Cargo" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
</section>
...
<section class="section-py bg-light">
    <div class="container">
        <div class="row align-items-center g-lg-5 flex-row-reverse">
            <div class="col-lg-6 mb-4 mb-lg-0 reveal-on-scroll">
                <div class="ps-lg-5">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/nsplsh_b01f9142d1f941c9b1fdfa8d6fc39e0b~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/nsplsh_b01f9142d1f941c9b1fdfa8d6fc39e0b~mv2.jpg"
                    alt="Air Freight" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
</section>
...
<section class="section-py bg-white">
    <div class="container">
        <div class="row align-items-center g-lg-5">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/nsplsh_6d97f01dd18643a192e4fdad71bfc01f~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/nsplsh_6d97f01dd18643a192e4fdad71bfc01f~mv2.jpg"
                    alt="FCL Services" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
</section>
...
<section class="section-py bg-light">
    <div class="container">
        <div class="row align-items-center g-lg-5 flex-row-reverse">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/11062b_b58444d0dad140688dc506c9f8e23f91~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/11062b_b58444d0dad140688dc506c9f8e23f91~mv2.jpg"
                    alt="Air Freight" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
...
<section class="section-py bg-white">
    <div class="container">
        <div class="row align-items-center g-lg-5">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/nsplsh_32ad5857615847d6810ff51c3ea0ac51~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/nsplsh_32ad5857615847d6810ff51c3ea0ac51~mv2.jpg"
                    alt="Customs Brokerage" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
</section>
...
<section class="section-py bg-light">
    <div class="container">
        <div class="row align-items-center g-lg-5 flex-row-reverse">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/b7569128e76a405e9b04cc240497d066.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/b7569128e76a405e9b04cc240497d066.jpg"
                    alt="Buyer's Consolidation" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
</section>
...
<section class="section-py bg-white">
    <div class="container">
        <div class="row align-items-center g-lg-5">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/nsplsh_5272cd3660bc4391a8d51f6c9243b9e2~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/nsplsh_5272cd3660bc4391a8d51f6c9243b9e2~mv2.jpg"
                    alt="Inland Transport" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
</section>
...
<section class="section-py bg-light">
    <div class="container">
        <div class="row align-items-center g-lg-5 flex-row-reverse">
            <div class="col-lg-6 mb-4 mb-lg-0 reveal-on-scroll">
                <div class="ps-lg-5">
                    <img src="https://static.wixstatic.com/media/36e2c8_bd85dbc558a94f6793b34b8c8fa08a3e~mv2.png/v1/fill/w_83,h_80,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/Combined%20sea%20and%20air%20transport.png"
                        alt="Customs Icon" style="width: 60px;" class="mb-3">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/36e2c8_c23a870951c4438f86cee5bacab5c061~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/36e2c8_c23a870951c4438f86cee5bacab5c061~mv2.jpg"
                    alt="Customs Brokerage" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
...
<section class="section-py bg-white">
    <div class="container">
        <div class="row align-items-center g-lg-5">
            ...
            <div class="col-lg-6 reveal-on-scroll delay-200 text-center">
                <img src="https://static.wixstatic.com/media/nsplsh_9d78fb279bda4d159c450179f0b2bb42~mv2.jpg/v1/fill/w_1026,h_702,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/nsplsh_9d78fb279bda4d159c450179f0b2bb42~mv2.jpg"
                    alt="Customs Brokerage" class="img-fluid rounded shadow-sm">
            </div>
        </div>
    </div>
