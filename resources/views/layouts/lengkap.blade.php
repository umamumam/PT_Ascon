                                    ...
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <button
                                                ...
                                                type="button" id="vehiclesOverview" data-bs-toggle="dropdown"
                                    ...
                                    <div class="card-body">
                                        <div class="d-none d-lg-flex vehicles-progress-labels mb-6">
                                            ...
                                            <div class="vehicles-progress-label waiting-text text-nowrap"
                                                style="width: 14.6%">Waiting
                                            </div>
                                        </div>
                                        <div class="vehicles-overview-progress progress rounded-3 mb-6"
                                            style="height: 46px">
                                            ...
                                            <div class="progress-bar fw-medium text-start bg-primary px-4"
                                                role="progressbar" style="width: 28.3%" aria-valuenow="28.3"
                                                aria-valuemin="0" aria-valuemax="100">
                                                28.3%
                                            </div>
                                            <div class="progress-bar fw-medium text-start text-bg-info px-2 px-sm-4"
                                                    ...
                                                    <tr>
                                                        <td class="w-50 ps-0">
                                                            <div
                                                                ...
                                                                <div class="me-2">
                                                                    <i
                                                                        class="ti ti-circle-arrow-down ti-lg text-heading"></i>
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="w-50 ps-0">
                                                            <div
                                                                ...
                                                                <div class="me-2">
                                                                    <i
                                                                        class="ti ti-circle-arrow-up ti-lg text-heading"></i>
                                                                </div>
                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <button
                                                class="btn btn-text-secondary rounded-pill text-muted border-0 p-2 me-n1"
                                                type="button" id="deliveryExceptions" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                                <i class="ti ti-dots-vertical ti-md text-muted"></i>
                                            </button>
                                            <div class="dropdown-menu dropdown-menu-end"
                                            ...
                                            <div class="tab-content border-0 mx-1">
                                                    ...
                                                    <ul class="timeline mb-0">
                                                        <li class="timeline-item ps-6 border-left-dashed">
                                                            ...
                                                            <div class="timeline-event ps-1">
                                                                <div class="timeline-header">
                                                                    <small
                                                                        class="text-success text-uppercase">sender</small>
                                                                </div>
                                                        ...
                                                        <li class="timeline-item ps-6 border-transparent">
                                                            ...
                                                            <div class="timeline-event ps-1">
                                                                <div class="timeline-header">
                                                                    <small
                                                                        class="text-primary text-uppercase">Receiver</small>
                                                                </div>
                                                ...
                                                <div class="tab-pane fade" id="navs-justified-link-preparing"
                                                    ...
                                                    <ul class="timeline mb-0">
                                                        ...
                                                        <li
                                                            class="timeline-item ps-6 border-transparent border-left-dashed">
                                                            <span
                                                                class="timeline-indicator-advanced timeline-indicator-primary border-0 shadow-none">
                                                                <i class="ti ti-map-pin"></i>
                                                            </span>
                                                ...
                                                <div class="tab-pane fade" id="navs-justified-link-shipping"
                                                    role="tabpanel">
                                                    <ul class="timeline mb-0">
                                                        <li class="timeline-item ps-6 border-left-dashed">
                                                            <span
                                ...
                                <div class="card">
                                    <div class="card-header d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="dropdown">
                                            <button
                                                class="btn btn-text-secondary rounded-pill text-muted border-0 p-2 me-n1"
                                                type="button" id="routeVehicles" data-bs-toggle="dropdown"
                                                aria-haspopup="true" aria-expanded="false">
                                                <i class="ti ti-dots-vertical ti-md text-muted"></i>
                                            </button>
                                            <div class="dropdown-menu dropdown-menu-end"
