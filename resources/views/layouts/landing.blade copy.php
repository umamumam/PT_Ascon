    ...
    <footer class="landing-footer bg-body footer-text">
        ...
        <div class="footer-bottom py-3 py-md-5">
            <div
                ...
                <div>
                    <a href="#" class="me-3"><img src="../../assets/img/front-pages/icons/facebook.svg"
                            alt="facebook" /></a>
                    <a href="#" class="me-3"><img src="../../assets/img/front-pages/icons/twitter.svg"
                            alt="twitter" /></a>
                    <a href="#"><img src="../../assets/img/front-pages/icons/instagram.svg" alt="instagram" /></a>
                </div>
            </div>
        </div>
    </footer>
